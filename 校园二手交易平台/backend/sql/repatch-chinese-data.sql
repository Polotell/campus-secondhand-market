-- 修复已写成问号乱码的分类名 / 店铺名 / 演示商品（文件须保存为 UTF-8）
-- Windows 推荐：cmd /c "chcp 65001>nul && mysql --default-character-set=utf8mb4 -u root -p 2023011308 < backend/sql/repatch-chinese-data.sql"
